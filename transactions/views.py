...
class DepositMoneyView(TransactionCreateMixin):
    ...
    def form_valid(self, form):
        ...
        send_transaction_email(self.request.user, amount, 'Deposite Information', 'transactions/deposite_email.html', self.request.user)
...
class TransferMoneyView(TransactionCreateMixin):
    ...
    def form_valid(self, form):
        ...
        send_transaction_email(self.request.user, amount, 'Transfer Information', 'transactions/transfer_email.html', receiver)
        send_transaction_email(receiver.user, amount, 'Receive Information', 'transactions/receive_email.html', sender)
        return super().form_valid(form)
